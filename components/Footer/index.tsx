            ...
            <div className="flex w-full px-4 items-center justify-center">
              <div className="py-7 flex flex-col items-center text-center">
                ...
                <div className="flex justify-center">
                  ...
                  <a href="https://docs.google.com/document/d/1-qvCeh3H5G5Xi-Ju47w6gC1RyQ-v14qo/edit?usp=drive_link&ouid=116033998789940486808&rtpof=true&sd=true" aria-label="social-link" className="mr-6">
                  ...
                  <a href="https://wa.me/5537998057781" aria-label="social-link">
